...
namespace RGZIS
{
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            com = new NpgsqlCommand("select cf.name from typeroom as te, comfortroom as cr, comfort as cf where te.name='Двухкомнатный стандарт' and cf.idcom=cr.idcom and te.idtype=cr.idtyperoom;", connect);
            dr = com.ExecuteReader();
            while (dr.Read())
            {
