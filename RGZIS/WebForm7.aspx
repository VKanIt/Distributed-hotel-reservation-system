<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm7.aspx.cs" Inherits="RGZIS.WebForm7" %>
...
.text{
    ...
    <div><center>
        <h1 style="line-height:60px; margin-bottom:10px; font-family: 'Arial';">Стандарт с 2 кроватями</h1>
        <img style="margin-top:15px; margin-right:15px; height: 250px; width: 380px;" src="room3.png"/>
        <img style="margin-top:15px; margin-right:15px; height: 250px; width: 380px;" src="room31.jpg"/>
        <img style="margin-top:15px; margin-right:15px; height: 250px; width: 380px;" src="room32.jpg"/></center>
    </div>
